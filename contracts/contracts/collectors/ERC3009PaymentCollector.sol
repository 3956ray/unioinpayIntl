...
contract ERC3009PaymentCollector is TokenCollector, ERC6492SignatureHandler {
    ...
    constructor(address escrow_, address multicall3_)
        TokenCollector(escrow_)
    ...
    function _collectTokens(
        ...
        // Pull tokens into this contract using ERC3009 receiveWithAuthorization
        ...
        if (maxAmount > amount) {
            SafeERC20.safeTransfer(IERC20(token), payer, maxAmount - amount);
        }
